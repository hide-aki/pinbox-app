...
describe('FileStructure', function () {
    it('should generate initial state of file record', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fsr;
        return __generator(this, function (_a) {
            fsr = new FileStructure_1.FileStructureRecord('originalFilePath', 'ipfsHash');
