...
describe('fileCrypt', function () {
    it('should read encrypt and decrypt correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
        var secret, inputFilePath, outputFilePath, decryptedOutputFilePath, decrypted, original;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fileCrypt_1.encryptFileTo({
                            secret: secret,
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, fileCrypt_1.decryptFileFrom({
                            secret: secret,
                ...
                case 2:
                    _a.sent();
                    decrypted = fs_1.readFileSync(decryptedOutputFilePath);
                    original = fs_1.readFileSync(inputFilePath);
